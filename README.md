...
*Note*: If you require LuaWheel when your window (HWND) is not in foreground, this will silently fail, but all functions will be available. Use [.IsAvailable()](#label-func-is-available) to check when LuaWheel is ready.
